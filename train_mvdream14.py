...
def main(args):
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            ...
            prob = torch.rand(1, device=accelerator.device)
            ...
            with accelerator.accumulate(unet, mv_teacher_lora, sd_teacher_lora):
                ...
                if mode == "mv":
                    ...
                    # center crop latents to 256 x 256
                    # h, w = original_samples.shape[-2:]
                    # new_size = (int(h * 0.5), int(w * 0.5))
                    # pred_original_samples = F_vision.center_crop(original_samples, new_size)
